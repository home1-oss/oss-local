...
#export MAVEN_OPTS="${MAVEN_OPTS} -Dfrontend.nodeDownloadRoot=http://nexus.local:28081/nexus/repository/npm-dist/"
#export MAVEN_OPTS="${MAVEN_OPTS} -Dfrontend.npmDownloadRoot=http://nexus.local:28081/nexus/repository/npm-public/npm/-/"
