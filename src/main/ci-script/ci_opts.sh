...
#export MAVEN_OPTS="${MAVEN_OPTS} -Dfrontend.nodeDownloadRoot=http://nexus3.local:28081/nexus/repository/npm-dist/"
#export MAVEN_OPTS="${MAVEN_OPTS} -Dfrontend.npmDownloadRoot=http://nexus3.local:28081/nexus/repository/npm-public/npm/-/"
